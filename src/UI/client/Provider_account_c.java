...
public class Provider_account_c {
    ...
    public static void main(String[] args) {
        // Use a dynamic title based on the user viewing the account
        String frameTitle = "EmployInverse - Provider Account";
        ...
        // ---------- Modern Navigation Bar (Standardized) ----------
        ...
        JLabel nameLabel = new JLabel("Provider: " + me_client.getUser_name());
        ...
        String headerName = provider.getName();
        String headerSubtitle = "Service Provider profile details";
    ...
    private static JPanel createAccountInfoCard(JFrame parentFrame) {
        ...
        // Card Title
        String cardTitleText = "Provider Details";
        ...
        // LOGIC PRESERVED: Current Job button action
        ...
        jobRow.add(jobBtn, BorderLayout.CENTER); // Replace the empty value label
        card.add(jobRow);
    ...
    private static JPanel createJobStatsCard(JFrame parentFrame) {
        ...
        JLabel statsIcon = new JLabel("✅"); // Checkmark icon
        ...
        jobCount.setForeground(new Color(16, 185, 129)); // Green for completed
