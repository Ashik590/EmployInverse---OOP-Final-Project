...
public class Applicants {
    ...
    public static void main(String[] args) {
        ...
        JFrame frame = new JFrame("EmployInverse - Applicants");
        ...
        JLabel titleLabel = new JLabel("Applicants for: " + service.getTitle());
        titleLabel.setFont(new Font("Segoe UI", Font.BOLD, 28));
        titleLabel.setForeground(new Color(30, 41, 59));
        titleLabel.setAlignmentX(Component.LEFT_ALIGNMENT);

        JLabel subtitleLabel = new JLabel("Review and manage job applicants");
        ...
        // View Service Button
        JButton viewServiceBtn = new JButton("View Job Details");
        viewServiceBtn.setFont(new Font("Segoe UI", Font.BOLD, 14));
        viewServiceBtn.setForeground(Color.WHITE);
        viewServiceBtn.setBackground(new Color(59, 130, 246));
        viewServiceBtn.setBorder(BorderFactory.createEmptyBorder(12, 24, 12, 24));
        viewServiceBtn.setFocusPainted(false);
        viewServiceBtn.setCursor(new Cursor(Cursor.HAND_CURSOR));

        viewServiceBtn.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                viewServiceBtn.setBackground(new Color(37, 99, 235));
            }
        ...
        titlePanel.add(viewServiceBtn, BorderLayout.EAST);
        ...
        if (applicants.isEmpty()) {
            ...
            // Applicants list
            applicantsContent = createApplicantsList(applicants, frame);
        }
    ...
    private static JPanel createEmptyState() {
        ...
        // Message
        JLabel messageLabel = new JLabel("No applicants yet");
        messageLabel.setFont(new Font("Segoe UI", Font.BOLD, 24));
        messageLabel.setForeground(new Color(100, 116, 139));
        messageLabel.setAlignmentX(Component.CENTER_ALIGNMENT);

        // Subtitle
        JLabel subtitleLabel = new JLabel("When providers apply for this job, they will appear here.");
        subtitleLabel.setFont(new Font("Segoe UI", Font.PLAIN, 14));
    ...
    private static JPanel createApplicantsList(ArrayList<ServiceProvider> applicants, JFrame frame) {
        ...
        applicantsListPanel.setBackground(new Color(245, 247, 250));

        for (int i = 0; i < applicants.size(); i++) {
            ServiceProvider applicant = applicants.get(i);
            JPanel applicantCard = createApplicantCard(applicant, i + 1);
            applicantsListPanel.add(applicantCard);
            applicantsListPanel.add(Box.createRigidArea(new Dimension(0, 15)));
        }
    ...
    private static JPanel createApplicantCard(ServiceProvider applicant, int number) {
        ...
        JLabel usernameLabel = new JLabel("@" + applicant.getUser_name());
