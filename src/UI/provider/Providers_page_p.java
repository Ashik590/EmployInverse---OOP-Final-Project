...
public class Providers_page_p {
    ...
    public static void main(String[] args) {
        ...
        JLabel subtitleLabel = new JLabel(providers.size() + " service provider" + (providers.size() != 1 ? "s" : "") + " found");
        ...
        // ---------- Clients Content ----------
        JPanel providersContent;

        if (providers.isEmpty()) {
            // Empty state
            providersContent = createEmptyState();
        } else {
            // Applicants list
            providersContent = createProvidersList(frame);
        }

        contentPanel.add(titlePanel, BorderLayout.NORTH);
        contentPanel.add(providersContent, BorderLayout.CENTER);
    ...
    private static JPanel createEmptyState() {
        ...
        // Message
        JLabel messageLabel = new JLabel("No service providers yet");
        messageLabel.setFont(new Font("Segoe UI", Font.BOLD, 24));
        messageLabel.setForeground(new Color(100, 116, 139));
        messageLabel.setAlignmentX(Component.CENTER_ALIGNMENT);

        // Subtitle
        JLabel subtitleLabel = new JLabel("When providers register in this site, they will appear here.");
        subtitleLabel.setFont(new Font("Segoe UI", Font.PLAIN, 14));
    ...
    private static JPanel createProvidersList(JFrame frame) {
        ...
        for (int i = 0; i < providers.size(); i++) {
            ...
            JPanel providerCard = createProviderCard(provider, i + 1, frame);
    ...
    private static JPanel createProviderCard(ServiceProvider provider, int number, JFrame parentFrame) {
